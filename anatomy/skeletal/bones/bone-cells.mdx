...
<div className="doc-flex">
  ...
  />
  <div>
    The <span class="accent">osteoblasts</span>, <span class="accent">osteogenic</span> (progenitor) cells, and <span class="accent">osteoclasts</span> are located on bone **surfaces**, such as the <strong>periosteum</strong> (outer surface) and <strong>endosteum</strong> (inner lining).

    The <span class="accent">osteocytes</span>(mature bone cells) reside **deep within the bone matrix**, trapped in small spaces called **lacunae**.
...
<span class="accent">Osteoblasts</span> live on the **surfaces of bone** (That's the **periosteal AND endosteal**, inside it too!) and are responsible for **building new bone**. They secrete a soft, organic matrix called <span class="accent">osteoid</span>, which later mineralizes to become hard bone.
...
<strong>Osteoblasts</strong> (bone-forming cells) →<br />
<strong>Osteocytes</strong> (mature bone-maintaining cells)
</div>
...
Bone lining cells, or <span class="accent">inactive osteoblasts</span> are **flattened, inactive osteoblasts** that remain on the bone surface when no active remodeling is occurring.
...
<span class="accent">Osteogenic cells</span> (osteoprogenitor cells) are **stem-like cells** found in the **periosteum**, **endosteum**, and **bone marrow**.
...
Once osteoblasts get trapped in the mineralized bone matrix, they become <span class="accent">osteocytes</span>.

- Live in small cavities called **lacunae**, in the bone matrix!
    - One example of this is in the bone units of <span class="accent">osteons</span>, and everywhere else too.
...
<span class="accent">Osteoclasts</span> are **large, multinucleated cells** that break down bone.
...
---
Hopefully you can name these, despite the messy doodle.
<img
  src="/img/anatomy/skeletal/bone-cells.png"
  className="doc-image img-margin-right"
  alt="Bone Cell Summary Diagram"
/>
