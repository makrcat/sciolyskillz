...
<span className="accent">Appositional growth</span> occurs when new bone matrix is added to the bone **surfaces**, expanding the bone’s thickness.
...
<span className="accent">Interstitial growth</span> isn't directly bone growth; It's actually bone replacing cartilage. It happens especially at the epiphyseal plate (growth plate) during development. This is called <span className="accent">endochondral ossification </span>.
