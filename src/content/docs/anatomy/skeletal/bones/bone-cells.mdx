...
<span className="accent">Osteoblasts</span> live on the surfaces of bone (periosteal) and inside the bone (endosteal) and are responsible for building new bone. They secrete a soft, organic matrix called <span className="accent">osteoid</span>, which later mineralizes to become hard bone.
