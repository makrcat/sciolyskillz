...
export default function SidebarElement({ icon, label, href }: SidebarElementProps) {
  return (
    <li className="flex flex-row items-center gap-2 pl-3 hover:bg-gray-200 rounded-md transition-colors duration-200">

      <HugeiconsIcon icon={icon} size={24} strokeWidth={1.5} />
      <button
        type="button"
        className="w-full text-left px-2 py-2 rounded text-lg cursor-pointer"
